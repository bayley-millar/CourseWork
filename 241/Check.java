...
public class Check{
    ...
    protected integer addToRow(Cell curr, int value){
        ...
        if(curr.right==null && value > curr.value){
            ...
            curr.right = cellA;
            cellA.left = curr;
            if(curr.above != null && curr.above.right){
                cellA.above = curr.above.right;
                cellA.above.below = cellA;
            }
            return null;
    ...
    public void addValue(Integer value){
        ...
        Cell curr = smallest;
        Integer returned = addToRow(curr, value);
        if(returned == null){
            return;
        }else{
            while(returned != null && curr.below != null){
                curr = curr.below;
                returned = addToRow(curr, returned);
            }
            if(returned != null){
                cellA = new Cell(returned);
                curr.below = cellA;
                cellA.above = curr;
            }
        }
    ...
    protected Integer addToRow(curr, value){
        Cell cellA;
        int prevValue;
        while(curr.right!=null && value > curr.value){
            curr = curr.right;
