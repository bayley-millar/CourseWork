...
<?php
$scriptList = array('JS/jquery-3.1.0.min.js', 'JS/showCart.js', 'JS/cookies.js', 'JS/sampleValidator.js', 'JS/cart.js');
...
<div id="main">
    ...
    <p id="total"></p>
    <div id="errors"></div>
    <input type="button" id="clear" value="clear cart">
    ...
    <form id="checkoutForm" action="validateCheckout.php" method="POST" novalidate>
        ...
        <fieldset>
            ...
            <p>
                ...
                keepValues("deliveryEmail");
                ?>
                >
            </p>
            <p>
                <label for="deliveryAddress1">Address:</label>
                <input type="text" name="deliveryAddress1" id="deliveryAddress1" required <?php
                keepValues("deliveryAddress1");
                ?>
                >
            </p>
            <p>
                ...
                <input type="text" name="deliveryAddress2" id="deliveryAddress2"
                    <?php
                    keepValues("deliveryAddress2");
                    ?>
                >
            </p>
            <p>
                <label for="deliveryCity">City:</label>
                <input type="text" name="deliveryCity" id="deliveryCity" required <?php
                keepValues("deliveryCity");
                ?>
                >
            </p>
            <p>
