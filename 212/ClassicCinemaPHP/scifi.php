...
<?php
$scriptList = array('JS/jquery-3.1.0.min.js', 'JS/showHide.js', 'JS/cart.js', 'JS/cookies.js', 'JS/reviews.js');
...
<div id="main">
    ...
    <section class="film">
        ...
        <p>
            ...
            <input type="button" value="Add to Cart" class="buy">
            <?php addReviewForm('Plan_9_from_Outer_Space.xml'); ?>
        </p>
    </section>
    ...
    <section class="film">
        ...
        <p>
            $<span class="price">7.99</span>
            <input type="button" value="Add to Cart" class="buy">
            <?php addReviewForm('Tarantula.xml'); ?>
        </p>
    </section>
